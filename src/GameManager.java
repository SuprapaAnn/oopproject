...
public class GameManager {
    ...
    private void updateMazeFrame() {
        ...
        if (g.getPlayer().isDead()) {
 			...
 			JOptionPane.showOptionDialog (mazeFrame.getFrame(), "Nightmare killed you!","OH NO!",
 								JOptionPane.CLOSED_OPTION,JOptionPane.PLAIN_MESSAGE,
 								new ImageIcon(this.getClass().getResource("/sprites/NightmareW.gif")),options,options[0]);
			...
			JOptionPane.showOptionDialog (mazeFrame.getFrame(), "The next journey awaits you...\n" +
								...
								new ImageIcon(this.getClass().getResource("/sprites/opendoor.gif")),options,options[0]);
    ...
    private void showGameFrame() {
    	...
    	if (g.getLevel() == Game.MAX_LEVEL) {
			...
			JOptionPane.showOptionDialog (this.mazeFrame.getFrame(), "Congratulations!\n" +
						...
						+ "We will see again......and nightmare will miss you....",
						"Tower cleared!", 1,0,new ImageIcon(this.getClass().getResource("/sprites/opendoor.gif")), options, options[0]);
